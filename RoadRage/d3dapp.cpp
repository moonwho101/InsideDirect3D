...
DWORD GetAmountOfFreeVideoMemory();
...
BOOL(*D3DDeviceCreateCallback)(int, int, LPVOID);
...
extern void LoadCrossHair();


void PrintCapStatus(FILE *logfile, DWORD dwFXCaps, char *capname, DWORD cap);
...
void RRGetCaps()
{
	...
	if ((logfile = fopen("rrlogfile.txt", "a")) == 0) 
	{
		MessageBox(myglobs.hWndMain,"logfile error : Can't create", "rrlogfile.txt", MB_OK);
		return;
	} 

	if(d3dappi.lpDD7 == NULL)
	{
		fprintf(logfile, "RRGetCaps : FAILED d3dappi.lpDD7 = NULL\n");
		return;
	}

	d3dappi.DDDriverCaps.dwSize = sizeof(DDCAPS);
	d3dappi.DDHELCaps.dwSize = sizeof(DDCAPS);

	d3dappi.lpDD7->GetCaps(&d3dappi.DDDriverCaps, &d3dappi.DDHELCaps);
	dwFXCaps    = d3dappi.DDDriverCaps.dwFXCaps;
	dwSSBFXCaps = d3dappi.DDDriverCaps.dwSSBFXCaps;
	dwSVBFXCaps = d3dappi.DDDriverCaps.dwSVBFXCaps;
	dwVSBFXCaps = d3dappi.DDDriverCaps.dwVSBFXCaps;

	// PRINT dwFXCaps
	fprintf(logfile, "\n dwFXCaps \n");
	PrintCapStatus(logfile, dwFXCaps, "DDFXCAPS_BLTSHRINKX", DDFXCAPS_BLTSHRINKX);
	PrintCapStatus(logfile, dwFXCaps, "DDFXCAPS_BLTSHRINKY", DDFXCAPS_BLTSHRINKY);
	PrintCapStatus(logfile, dwFXCaps, "DDFXCAPS_BLTSTRETCHX", DDFXCAPS_BLTSTRETCHX);
	PrintCapStatus(logfile, dwFXCaps, "DDFXCAPS_BLTSTRETCHY", DDFXCAPS_BLTSTRETCHY);


	// PRINT dwSSBCaps
	fprintf(logfile, "\n dwSSBFXCaps (system to system blit FX)\n");
	PrintCapStatus(logfile, dwSSBFXCaps, "DDFXCAPS_BLTSHRINKX", DDFXCAPS_BLTSHRINKX);
	PrintCapStatus(logfile, dwSSBFXCaps, "DDFXCAPS_BLTSHRINKY", DDFXCAPS_BLTSHRINKY);
	PrintCapStatus(logfile, dwSSBFXCaps, "DDFXCAPS_BLTSTRETCHX", DDFXCAPS_BLTSTRETCHX);
	PrintCapStatus(logfile, dwSSBFXCaps, "DDFXCAPS_BLTSTRETCHY", DDFXCAPS_BLTSTRETCHY);


	// PRINT dwSVBCaps
	fprintf(logfile, "\n dwSVBFXCaps (system to video blit FX)\n");
	PrintCapStatus(logfile, dwSVBFXCaps, "DDFXCAPS_BLTSHRINKX", DDFXCAPS_BLTSHRINKX);
	PrintCapStatus(logfile, dwSVBFXCaps, "DDFXCAPS_BLTSHRINKY", DDFXCAPS_BLTSHRINKY);
	PrintCapStatus(logfile, dwSVBFXCaps, "DDFXCAPS_BLTSTRETCHX", DDFXCAPS_BLTSTRETCHX);
	PrintCapStatus(logfile, dwSVBFXCaps, "DDFXCAPS_BLTSTRETCHY", DDFXCAPS_BLTSTRETCHY);

	// PRINT dwVSBCaps
	fprintf(logfile, "\n dwVSBFXCaps (video to system blit FX)\n");
	PrintCapStatus(logfile, dwVSBFXCaps, "DDFXCAPS_BLTSHRINKX", DDFXCAPS_BLTSHRINKX);
	PrintCapStatus(logfile, dwVSBFXCaps, "DDFXCAPS_BLTSHRINKY", DDFXCAPS_BLTSHRINKY);
	PrintCapStatus(logfile, dwVSBFXCaps, "DDFXCAPS_BLTSTRETCHX", DDFXCAPS_BLTSTRETCHX);
	PrintCapStatus(logfile, dwVSBFXCaps, "DDFXCAPS_BLTSTRETCHY", DDFXCAPS_BLTSTRETCHY);

	fprintf(logfile, "\n");


	d3dappi.lpDD7->GetCaps(&d3dappi.DDDriverCaps, &d3dappi.DDHELCaps);
	dwFXCaps    = d3dappi.DDHELCaps.dwFXCaps;
	dwSSBFXCaps = d3dappi.DDHELCaps.dwSSBFXCaps;
	dwSVBFXCaps = d3dappi.DDHELCaps.dwSVBFXCaps;
	dwVSBFXCaps = d3dappi.DDHELCaps.dwVSBFXCaps;
	...
	// PRINT dwSSBCaps
	fprintf(logfile, "\nHEL : dwSSBFXCaps (system to system blit FX)\n");
	PrintCapStatus(logfile, dwSSBFXCaps, "DDFXCAPS_BLTSHRINKX", DDFXCAPS_BLTSHRINKX);
	PrintCapStatus(logfile, dwSSBFXCaps, "DDFXCAPS_BLTSHRINKY", DDFXCAPS_BLTSHRINKY);
	PrintCapStatus(logfile, dwSSBFXCaps, "DDFXCAPS_BLTSTRETCHX", DDFXCAPS_BLTSTRETCHX);
	PrintCapStatus(logfile, dwSSBFXCaps, "DDFXCAPS_BLTSTRETCHY", DDFXCAPS_BLTSTRETCHY);
	...
	// PRINT dwSVBCaps
	fprintf(logfile, "\nHEL : dwSVBFXCaps (system to video blit FX)\n");
	PrintCapStatus(logfile, dwSVBFXCaps, "DDFXCAPS_BLTSHRINKX", DDFXCAPS_BLTSHRINKX);
	PrintCapStatus(logfile, dwSVBFXCaps, "DDFXCAPS_BLTSHRINKY", DDFXCAPS_BLTSHRINKY);
	PrintCapStatus(logfile, dwSVBFXCaps, "DDFXCAPS_BLTSTRETCHX", DDFXCAPS_BLTSTRETCHX);
	PrintCapStatus(logfile, dwSVBFXCaps, "DDFXCAPS_BLTSTRETCHY", DDFXCAPS_BLTSTRETCHY);
	...
	// PRINT dwVSBCaps
	fprintf(logfile, "\nHEL : dwVSBFXCaps (video to system blit FX)\n");
	PrintCapStatus(logfile, dwVSBFXCaps, "DDFXCAPS_BLTSHRINKX", DDFXCAPS_BLTSHRINKX);
	PrintCapStatus(logfile, dwVSBFXCaps, "DDFXCAPS_BLTSHRINKY", DDFXCAPS_BLTSHRINKY);
	PrintCapStatus(logfile, dwVSBFXCaps, "DDFXCAPS_BLTSTRETCHX", DDFXCAPS_BLTSTRETCHX);
	PrintCapStatus(logfile, dwVSBFXCaps, "DDFXCAPS_BLTSTRETCHY", DDFXCAPS_BLTSTRETCHY);
			  ...
			  D3DAppInfo** D3DApp)
{
	...
	PrintMessage(myglobs.hWndMain, "D3DAppCreateFromHWND : starting\n", NULL, LOGFILE_ONLY);
    ...
    *D3DApp = &d3dappi;
	...
	//MessageBeep(0);
	PrintMessage(myglobs.hWndMain, "D3DAppCreateFromHWND : suceeded\n", NULL, LOGFILE_ONLY);
...
exit_with_error:
    ...
    RELEASE(d3dappi.lpDD7);
	PrintMessage(myglobs.hWndMain, "D3DAppCreateFromHWND : failed\n", NULL, LOGFILE_ONLY);
...
BOOL D3DAppFullscreen(int mode)
{
	...
	PrintMessage(myglobs.hWndMain, "D3DAppFullscreen : starting\n", NULL, LOGFILE_ONLY);
	...
	PrintMessage(myglobs.hWndMain, "D3DAppFullscreen : D3DAppIReleaseAllTextures", NULL, LOGFILE_ONLY);
    RELEASE(d3dappi.lpD3DDevice);
    RELEASE(d3dappi.lpZBuffer);
    RELEASE(lpPalette);
    RELEASE(lpClipper);
    ...
    D3DAppIValidateDirtyRects();
    d3dappi.bRenderingIsOK = TRUE;
	PrintMessage(myglobs.hWndMain, "D3DAppFullscreen : suceeded\n", NULL, LOGFILE_ONLY);
    return TRUE;
...
exit_with_error:
	...
	PrintMessage(myglobs.hWndMain, "D3DAppFullscreen : FAILED\n", NULL, LOGFILE_ONLY);
...
DWORD GetAmountOfFreeVideoMemory()
{
	...
	return free_memory_for_textures;
}
...
BOOL D3DAppWindow(int w, int h)
{
	...
	PrintMessage(myglobs.hWndMain, "D3DAppWindow : starting\n", NULL, LOGFILE_ONLY);
	...
	mem = (int)GetAmountOfFreeVideoMemory();
	mem = mem /1024;
	itoa(mem, buffer, 10);
	strcat(buffer, " KB\n");
	PrintMessage(myglobs.hWndMain, "\n **** D3DAppWindow : Free mem for textures = ", buffer, LOGFILE_ONLY);
	...
	PrintMessage(myglobs.hWndMain, "D3DAppWindow : D3DAppIReleaseAllTextures", buffer, LOGFILE_ONLY);
    RELEASE(d3dappi.lpD3DDevice);
    RELEASE(d3dappi.lpZBuffer);
    RELEASE(lpPalette);
    RELEASE(lpClipper);
    ...
    D3DAppIValidateDirtyRects();
    d3dappi.bRenderingIsOK = TRUE;
	PrintMessage(myglobs.hWndMain, "D3DAppWindow : suceeded\n", NULL, LOGFILE_ONLY);
...
exit_with_error:
    ...
    RELEASE(d3dappi.lpBackBuffer);
    RELEASE(d3dappi.lpFrontBuffer);
	PrintMessage(myglobs.hWndMain, "D3DAppWindow : failed\n", NULL, LOGFILE_ONLY);
...
BOOL D3DAppAddTexture(const char* imagefile)
{
    ...
    if (d3dappi.ThisDriver.bDoesTextures && d3dappi.NumUsableTextures == d3dappi.NumTextures) 
	{
		...
		{
			PrintMessage(myglobs.hWndMain, "Error in D3DAppAddTexture\n", NULL, LOGFILE_ONLY);
...
BOOL D3DAppChangeTextureFormat(int format)
{
	...
	PrintMessage(myglobs.hWndMain, "D3DAppChangeTextureFormat", NULL, LOGFILE_ONLY);
...
//exit_with_error:
    D3DAppIReleaseAllTextures();
	PrintMessage(myglobs.hWndMain, "Error in D3DAppChangeTextureFormat\n", NULL, LOGFILE_ONLY);
	PrintMessage(myglobs.hWndMain, "D3DAppIReleaseAllTextures 7", NULL, LOGFILE_ONLY);
    return FALSE;
}
...
BOOL D3DAppShowBackBuffer(DWORD flags)
{
	...
	else 
	{
		...
		if (flags & D3DAPP_SHOWALL) 
		{
			...
			NumBufferRects = 1;
			SetRect(&buffer[0], 0, 0, d3dappi.szClient.cx, d3dappi.szClient.cy);
			SetRect(&front[0],
...
D3DAppClearBackBuffer(DWORD flags)
{
	...
	dummy.y2 = d3dappi.szClient.cy;
	LastError =
	          d3dappi.lpD3DDevice->Clear(1, &dummy, clearflags, NULL, NULL, NULL);
	if (LastError != D3D_OK) {
	...
	//
	LastError =
	          d3dappi.lpD3DDevice->Clear( NumDirtyBackRects,
						DirtyBack, D3DCLEAR_TARGET, NULL, NULL, NULL);
	if (LastError != D3D_OK) {
	...
	//
	LastError =
	          d3dappi.lpD3DDevice->Clear(NumDirtyZRects,
					       DirtyZ, D3DCLEAR_ZBUFFER, NULL, NULL, NULL);
	if (LastError != D3D_OK) {
...
BOOL D3DAppCheckForLostSurfaces(void)
{
	...
	//PrintMessage(myglobs.hWndMain, "D3DAppCheckForLostSurfaces : reloading textures\n", NULL, LOGFILE_ONLY);
...
BOOL D3DAppPause(BOOL flag)
{
	...
	//
        ...
        if (d3dappi.lpDD7) 
		{
            LastError = d3dappi.lpDD7->FlipToGDISurface();
...
BOOL D3DAppDestroy(void)
{
    ...
    ATTEMPT(D3DAppICallDeviceDestroyCallback());
    D3DAppIReleaseAllTextures();
	PrintMessage(myglobs.hWndMain, "D3DAppDestroy", NULL, LOGFILE_ONLY);
    RELEASE(d3dappi.lpD3DDevice);
    RELEASE(d3dappi.lpZBuffer);
    RELEASE(lpPalette);
    RELEASE(lpClipper);
