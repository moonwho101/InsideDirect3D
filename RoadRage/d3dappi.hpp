...
#include "d3dapp.hpp"
#include "d3dmacs.hpp"
#include "lclib.hpp"  /* lclib is a override for standard string lib */
...
extern BOOL(*D3DDeviceCreateCallback)(int, int, LPVOID);
...
HRESULT D3DAppIGetSurfDesc(LPDDSURFACEDESC2 lpDDSurfDesc,
