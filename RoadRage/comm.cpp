 ...
 */
HRESULT DPlayReceive(LPDIRECTPLAY4 glpDP, LPDPID lpidFrom, LPDPID lpidTo, DWORD dwFlags, LPVOID lpData, LPDWORD lpdwDataSize)
{
	HRESULT hr = E_FAIL;
 ...
 */
HRESULT DPlaySend(LPDIRECTPLAY4 glpDP, DPID idFrom, DPID idTo, DWORD dwFlags, LPVOID lpData, DWORD dwDataSize)
{
